...
public class StudentTimetableFragment extends Fragment {
    ...
    private StudentTimetableViewModel viewModel;

    public StudentTimetableFragment() {
        super(R.layout.fragment_student_timetable);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(StudentTimetableViewModel.class);

        View toolbar = view.findViewById(R.id.toolbar);
        ((TextView) toolbar.findViewById(R.id.textTitle)).setText(R.string.timetable_my_schedule_title);
        ...
        SimpleListAdapter<TimetableSlot> adapter = new SimpleListAdapter<>(R.layout.item_timetable_slot_card, (itemView, slot, position) -> {
            ...
            com.example.uos_lms.core.ui.AccentColors.applyBar(itemView.findViewById(R.id.accentBar), R.color.role_student_start);
