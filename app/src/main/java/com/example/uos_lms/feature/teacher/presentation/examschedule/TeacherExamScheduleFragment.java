...
@AndroidEntryPoint
public class TeacherExamScheduleFragment extends Fragment {

    private TeacherExamScheduleViewModel viewModel;

    public TeacherExamScheduleFragment() {
        super(R.layout.fragment_teacher_examschedule);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_teacher_examschedule, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(this).get(TeacherExamScheduleViewModel.class);
