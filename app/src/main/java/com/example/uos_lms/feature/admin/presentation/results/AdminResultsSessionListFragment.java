...
@AndroidEntryPoint
public class AdminResultsSessionListFragment extends Fragment {

    private AdminResultsSessionListViewModel viewModel;

    public AdminResultsSessionListFragment() {
        super(R.layout.fragment_admin_results_session_list);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_admin_results_session_list, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(this).get(AdminResultsSessionListViewModel.class);
        ...
        ((TextView) toolbar.findViewById(R.id.textTitle)).setText(departmentName != null ? departmentName : getString(R.string.select_session_title));
        ...
        SimpleListAdapter<Session> adapter = new SimpleListAdapter<>(R.layout.item_simple_nav_row, (itemView, session, position) -> {
            ...
            itemView.setOnClickListener(v -> {
                ...
                NavHostFragment.findNavController(this).navigate(R.id.adminResultsSemesterListFragment, navArgs);
            });
        });
