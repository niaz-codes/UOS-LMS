...
@AndroidEntryPoint
public class HodResultsSemesterListFragment extends Fragment {

    private HodResultsSemesterListViewModel viewModel;

    public HodResultsSemesterListFragment() {
        super(R.layout.fragment_hod_results_semester_list);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_hod_results_semester_list, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(this).get(HodResultsSemesterListViewModel.class);
        ...
        SimpleListAdapter<Semester> adapter = new SimpleListAdapter<>(R.layout.item_simple_nav_row, (itemView, semester, position) -> {
            ...
            itemView.setOnClickListener(v -> {
                ...
                NavHostFragment.findNavController(this).navigate(R.id.hodSemesterResultFragment, navArgs);
            });
        });
