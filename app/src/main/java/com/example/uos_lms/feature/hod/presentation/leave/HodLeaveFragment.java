...
@AndroidEntryPoint
public class HodLeaveFragment extends Fragment {

    private HodLeaveViewModel viewModel;

    public HodLeaveFragment() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(HodLeaveViewModel.class);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                viewModel.selectTab(tab.getPosition() == 0 ? LeaveReviewTab.PENDING : LeaveReviewTab.ALL);
            }
        ...
        viewModel.getUiState().observe(getViewLifecycleOwner(), state -> {
            ...
            ((TextView) emptyState.findViewById(R.id.textEmptyMessage)).setText(
                    state.getTab() == LeaveReviewTab.PENDING ? R.string.no_pending_leave_message : R.string.no_leave_applications_message);
