...
@AndroidEntryPoint
public class AdminAssignmentMonitorFragment extends Fragment {

    private AdminAssignmentMonitorViewModel viewModel;

    public AdminAssignmentMonitorFragment() {
        super(R.layout.fragment_admin_assignment_monitor);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_admin_assignment_monitor, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(this).get(AdminAssignmentMonitorViewModel.class);
        ...
        ((TextView) emptyState.findViewById(R.id.textEmptyMessage)).setText(R.string.no_assignments_yet);
        ...
        SimpleListAdapter<Assignment> adapter = new SimpleListAdapter<>(R.layout.item_assignment_monitor, (itemView, assignment, position) -> {
            AdminAssignmentMonitorUiState state = viewModel.getUiState().getValue();
            ...
            itemView.findViewById(R.id.buttonDelete).setOnClickListener(v ->
                    ConfirmDialogHelper.show(requireContext(),
                            getString(R.string.delete_assignment_title),
                            getString(R.string.delete_assignment_message, assignment.getTitle()),
