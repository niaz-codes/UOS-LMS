...
@AndroidEntryPoint
public class AdminSemesterResultFragment extends Fragment {

    private AdminSemesterResultViewModel viewModel;

    public AdminSemesterResultFragment() {
        super(R.layout.fragment_admin_semester_result_list);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_admin_semester_result_list, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(this).get(AdminSemesterResultViewModel.class);
        ...
        SimpleListAdapter<StudentSemesterResultSummary> adapter = new SimpleListAdapter<>(
                R.layout.item_teacher_result_student_row, (itemView, result, position) -> {
                    ...
                    itemView.setOnClickListener(v -> {
                        ...
                        NavHostFragment.findNavController(this).navigate(R.id.adminStudentSemesterResultFragment, navArgs);
                    });
                });
