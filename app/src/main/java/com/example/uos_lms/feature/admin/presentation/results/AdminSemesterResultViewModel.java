...
@HiltViewModel
public class AdminSemesterResultViewModel extends ViewModel {
    ...
    @Inject
    public AdminSemesterResultViewModel(SavedStateHandle savedStateHandle, ApiExamResultDataSource examResultDataSource) {
