...
@AndroidEntryPoint
public class StudentExamScheduleFragment extends Fragment {

    private StudentExamScheduleViewModel viewModel;

    public StudentExamScheduleFragment() {
        super(R.layout.fragment_student_examschedule);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_student_examschedule, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(this).get(StudentExamScheduleViewModel.class);
