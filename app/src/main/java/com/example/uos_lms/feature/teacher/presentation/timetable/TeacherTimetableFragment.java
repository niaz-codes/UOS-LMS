...
public class TeacherTimetableFragment extends Fragment {
    ...
    private TeacherTimetableViewModel viewModel;

    public TeacherTimetableFragment() {
        super(R.layout.fragment_teacher_timetable);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(TeacherTimetableViewModel.class);
        ...
        SimpleListAdapter<TimetableSlot> adapter = new SimpleListAdapter<>(R.layout.item_timetable_slot_card, (itemView, slot, position) -> {
            ...
            ((TextView) itemView.findViewById(R.id.textTeacher)).setVisibility(View.GONE);
