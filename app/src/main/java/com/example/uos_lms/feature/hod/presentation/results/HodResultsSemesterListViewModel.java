...
@HiltViewModel
public class HodResultsSemesterListViewModel extends ViewModel {
    ...
    @Inject
    public HodResultsSemesterListViewModel(SavedStateHandle savedStateHandle, ApiUniversityDataSource universityDataSource) {
