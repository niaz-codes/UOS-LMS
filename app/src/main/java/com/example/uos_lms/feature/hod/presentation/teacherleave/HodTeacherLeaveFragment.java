...
/** HOD reviews leave applications submitted by Teachers in their own department only - see
 * teacherLeaveController.decide (Admin or that exact department's HOD, never a peer Teacher).
 * Distinct from HodLeaveFragment, which is where the HOD reviews STUDENT leave requests. */
@AndroidEntryPoint
public class HodTeacherLeaveFragment extends Fragment {

    private HodTeacherLeaveViewModel viewModel;

    public HodTeacherLeaveFragment() {
        super(R.layout.fragment_hod_leave);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_hod_leave, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(this).get(HodTeacherLeaveViewModel.class);

        View toolbar = view.findViewById(R.id.toolbar);
        ((TextView) toolbar.findViewById(R.id.textTitle)).setText(R.string.hod_teacher_leave_title);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                viewModel.selectTab(tab.getPosition() == 0 ? TeacherLeaveReviewTab.PENDING : TeacherLeaveReviewTab.ALL);
            }
        ...
        viewModel.getUiState().observe(getViewLifecycleOwner(), state -> {
            ...
            ((TextView) emptyState.findViewById(R.id.textEmptyMessage)).setText(
                    state.getTab() == TeacherLeaveReviewTab.PENDING ? R.string.no_pending_leave_message : R.string.no_leave_applications_message);
