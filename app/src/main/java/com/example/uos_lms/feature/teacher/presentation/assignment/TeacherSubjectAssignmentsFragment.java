...
@AndroidEntryPoint
public class TeacherSubjectAssignmentsFragment extends Fragment {

    private TeacherSubjectAssignmentsViewModel viewModel;
    private boolean resumedOnce;

    public TeacherSubjectAssignmentsFragment() {
        super(R.layout.fragment_teacher_subject_assignments);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_teacher_subject_assignments, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(this).get(TeacherSubjectAssignmentsViewModel.class);
        ...
        ((TextView) emptyState.findViewById(R.id.textEmptyMessage)).setText(R.string.no_assignments_tap_add);
        ...
        SimpleListAdapter<Assignment> adapter = new SimpleListAdapter<>(R.layout.item_assignment_monitor, (itemView, assignment, position) -> {
            ...
            itemView.setOnClickListener(v -> {
                ...
                args.putString("title", assignment.getTitle());
                args.putInt("maxMarks", assignment.getMaxMarks());
                NavHostFragment.findNavController(this).navigate(R.id.assignmentSubmissionsFragment, args);
            });
        });
        ...
        view.findViewById(R.id.fabAdd).setOnClickListener(v -> {
            ...
            NavHostFragment.findNavController(this).navigate(R.id.createAssignmentFragment, navArgs);
        });
