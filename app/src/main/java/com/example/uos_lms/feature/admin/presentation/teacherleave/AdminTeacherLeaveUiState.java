...
public class AdminTeacherLeaveUiState {
    @Builder.Default
    private final AdminTeacherLeaveReviewTab tab = AdminTeacherLeaveReviewTab.PENDING;
    @Builder.Default
    ...
    public static AdminTeacherLeaveUiState initial() {
        return AdminTeacherLeaveUiState.builder().build();
    }

    public List<TeacherLeaveApplication> getVisibleLeaves() {
        if (tab == AdminTeacherLeaveReviewTab.PENDING) return pending;
