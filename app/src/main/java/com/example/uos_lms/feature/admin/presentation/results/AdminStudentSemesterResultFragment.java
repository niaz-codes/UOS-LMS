...
@AndroidEntryPoint
public class AdminStudentSemesterResultFragment extends Fragment {

    private AdminStudentSemesterResultViewModel viewModel;

    public AdminStudentSemesterResultFragment() {
        super(R.layout.fragment_admin_student_semester_result);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_admin_student_semester_result, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        viewModel = new ViewModelProvider(this).get(AdminStudentSemesterResultViewModel.class);
