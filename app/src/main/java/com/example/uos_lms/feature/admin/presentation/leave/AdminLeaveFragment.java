...
public class AdminLeaveFragment extends Fragment {
    ...
    private AdminLeaveViewModel viewModel;

    public AdminLeaveFragment() {
        super(R.layout.fragment_admin_leave);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(AdminLeaveViewModel.class);
        ...
        viewModel.getUiState().observe(getViewLifecycleOwner(), state -> {
            ...
            adapter.submitList(state.getSortedLeaves());
