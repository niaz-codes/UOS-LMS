...
@HiltViewModel
public class HodTeacherLeaveViewModel extends ViewModel {

    private final ApiTeacherLeaveDataSource leaveDataSource;

    private final MutableLiveData<HodTeacherLeaveUiState> uiState = new MutableLiveData<>(HodTeacherLeaveUiState.initial());

    @Inject
    public HodTeacherLeaveViewModel(ApiTeacherLeaveDataSource leaveDataSource) {
    ...
    public LiveData<HodTeacherLeaveUiState> getUiState() {
        return uiState;
    }

    public void selectTab(TeacherLeaveReviewTab tab) {
